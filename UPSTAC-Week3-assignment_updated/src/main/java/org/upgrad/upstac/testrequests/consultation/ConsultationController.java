...
//to get the list of test requests which are having status as 'LAB_TEST_COMPLETED'
...
// toGet the logged in user
        User doctor = userLoggedInService.getLoggedInUser();

        // to return the list of test requests assigned to current doctor (current user)
    ...
    public TestRequest assignForConsultation(@PathVariable Long id) {
        ...
        try {
            ...
            //assign a particular test request to the current doctor(logged in user)
    ...
    public TestRequest updateConsultation(@PathVariable Long id,@RequestBody CreateConsultationRequest testResult) {
        ...
        try {
            ...
            //update the result of the current test request id with test doctor comments
